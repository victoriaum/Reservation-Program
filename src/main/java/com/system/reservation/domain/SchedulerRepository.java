...
public interface SchedulerRepository extends JpaRepository<Scheduler, Long> {
  ...
  @Query("SELECT s.schedule_no, s.schedule_start, s.schedule_end, s.schedule_attender, s.schedule_space FROM Scheduler s WHERE s.teacher_id=:teacher_id AND s.schedule_date>=:startDate AND s.schedule_date<=:endDate"
      + " ORDER BY s.schedule_date, s.schedule_start ASC")
  ...
  @Query("SELECT s.schedule_no, s.schedule_start, s.schedule_end, t.teacher_dept, t.teacher_name, t.teacher_position"
      + " FROM Scheduler s LEFT JOIN Teacher t"
      + " ON s.teacher_id = t.teacher_id"
